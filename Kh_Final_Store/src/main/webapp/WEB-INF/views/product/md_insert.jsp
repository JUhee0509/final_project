...
<html>
	<head>
		...
		<script>
			/* 상품 데이터 확인 */
			function ItemNumber() {
			    var checkItemNumber = document.querySelector('input[name="p_idx"]').value;
			    var ItemNumbers = [...document.querySelectorAll('.product .row .col-3')].map(td => td.textContent.trim());
			
			    if (ItemNumbers.includes(checkItemNumber)) {
			        document.forms[0].action = "md_insert.do";
				...
				<form method="post" enctype="multipart/form-data">
					<div>
						<div class="row">
							...
							<div class="col-3">
								<input type="button" class="bttn" value="등록하기" onclick="ItemNumber();">
							</div>
						</div>
					</div>
					<br>
