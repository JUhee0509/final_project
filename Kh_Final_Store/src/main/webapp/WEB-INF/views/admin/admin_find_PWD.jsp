...
<head>
    ...
    <script>
        function find_Pwd(f) {
            ...
            if (a_id === '' || name === '' || inputEmail === '' || selectEmail === '') {
            	alert("올바른 정보를 입력해주세요");
            	return;
            }
            
            let url = "adminFindPwd.do";
            let param = "a_id=" + a_id + "&name=" + name + "&email=" + encodeURIComponent(email);
            sendRequest(url, param, admin_FindPWD, "post");
        }
        
        let res;
        
        function admin_FindPWD() {
            if (xhr.readyState == 4 && xhr.status == 200) {
                let data = xhr.responseText;
                let json = (new Function('return ' + data))();
                if (json[0].result == "a_id_no") {
		            ...
		            form.setAttribute("action", "admin_login_main.do");
...
<body>
    <div class="fixed-top">
		...
		<h2 align="center">관리자 비밀번호 찾기</h2>
        <form>
	    <div class="box">
            <div class="text-center">
            	<div>
                	<input type="text" class="id" name="a_id" autofocus placeholder="아이디">
                </div>
            	<div>
	    	...
	    	<div class="find_ID">
                <a href="admin_find_ID.do">아이디를 잊어버리셨나요?</a>
            </div>
        </form>
</body>
</html>
